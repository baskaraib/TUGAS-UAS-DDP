  ...
  switch(pilhome){
    ...
    //penjumlahan desimal//
        if(pil1==1){
            ...
            cout<<endl;
            cout<<"Hasil "<<bilangan[0]<<" + "<<bilangan[1]<<" = "<<jumlah<<endl<<endl;
    ...
    //pembagian desimal//
            ...
            cout<<endl;
            cout<<"Hasil "<<bagi<<" / "<<pembagi<<" = "<<hasilbagi<<endl<<endl;
            cout<<"Ulang? 1.Ya/2.Tidak/3.Home"<<endl;
            cin>>ulang;
                if(ulang == 1){
                    system("clear");
    ...
    //Pembagian oktal//
        ...
        while(jum>0){       
            ...
            cout<<"Hasil oktal 1 / oktal 2 = "<<tetap;
